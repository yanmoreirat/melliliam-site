...
GRANT EXECUTE ON FUNCTION public.get_order_by_number_and_phone TO anon, authenticated;
GRANT EXECUTE ON FUNCTION public.get_product_public_url TO anon, authenticated;